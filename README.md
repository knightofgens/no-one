...
local function TADOZOY_fake_script() -- CL.LocalScript 
...
coroutine.wrap(TADOZOY_fake_script)()
local function BWUZO_fake_script() -- Ex.LocalScript 
...
coroutine.wrap(BWUZO_fake_script)()
local function FNDBNUX_fake_script() -- Ex.Script 
...
coroutine.wrap(FNDBNUX_fake_script)()
local function XRXOM_fake_script() -- Hid.LocalScript 
	local script = Instance.new('LocalScript', Hid)
	local req = require
	local require = function(obj)
		local fake = fake_module_scripts[obj]
		if fake then
	...
	-- Don't forget to subscribe to scrambles! :D
		...
		script.Parent.Parent.Frame1.TextBox.TextTransparency = 0.1
		wait()
		script.Parent.Parent.Frame1.TextBox.TextTransparency = 0.2
		wait()
		script.Parent.Parent.Frame1.TextBox.TextTransparency = 0.3
		wait()
		script.Parent.Parent.Frame1.TextBox.TextTransparency = 0.4
		wait()
		script.Parent.Parent.Frame1.TextBox.TextTransparency = 0.5
		wait()
		script.Parent.Parent.Frame1.TextBox.TextTransparency = 0.6
		wait()
		script.Parent.Parent.Frame1.TextBox.TextTransparency = 0.7
		wait()
		script.Parent.Parent.Frame1.TextBox.TextTransparency = 0.8
		wait()
		script.Parent.Parent.Frame1.TextBox.TextTransparency = 0.9
		wait()
		script.Parent.Parent.Frame1.TextBox.TextTransparency = 1
		wait()
		hidden = true
	else
		hidden = false
		...
		script.Parent.Parent.Frame1.TextBox.TextTransparency = 0.1
		wait()
		script.Parent.Parent.Frame1.TextBox.TextTransparency = 0
		wait()
	end	
	end)
	
end
coroutine.wrap(XRXOM_fake_script)()
local function UFYMW_fake_script() -- R6.LocalScript 
...
coroutine.wrap(UFYMW_fake_script)()
local function IKEZC_fake_script() -- nil.Script 
...
coroutine.wrap(IKEZC_fake_script)()
local function EPSQF_fake_script() -- RE.LocalScript 
...
coroutine.wrap(EPSQF_fake_script)()
local function YYAQFCW_fake_script() -- RE.ServerEvents 
...
coroutine.wrap(YYAQFCW_fake_script)()
local function NBWM_fake_script() -- Frame1.SmoothDrag 
	...
	local Drag = script.Parent.Parent.Frame1
...
coroutine.wrap(NBWM_fake_script)()
